  ...
  <!--  fim da Navbar --> 
    ...
    <section class="comunidades-hero" style="text-align:center; margin-top:40px; margin-bottom:30px;">
        ...
        <p style="font-size:1.2rem; color:#333; max-width:600px; margin:0 auto 10px auto;">
           <strong>Seja bem-vindo à página de Poesias Bibliotec!</strong><br>
            Encontre, crie e leia livros de poesias compartilhados por nossa comunidade apaixonada por literatura.<br>
        </p>
    </section>
    <div class="bloco-comunidades" style="display: flex; flex-direction: column; gap: 24px; justify-content: center; align-items: center;">
        <h2 class="titulo2" style="color:#222; font-size:1.7rem; margin-bottom:10px; width:100%;">Livros de poesias em destaque:</h2>
       <?php
