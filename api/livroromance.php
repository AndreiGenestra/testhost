...
$mysql -> conecta();
$sqlstring = "select * from livros where id_genero=2"; 
 ...
 <!-- NAVBAR -->
  ...
  <!--  fim da Navbar --> 
    ...
    <section class="comunidades-hero" style="text-align:center; margin-top:40px; margin-bottom:30px;">
        <h1 class="titulo1" style="font-size:2.5rem; color:#393bb5; margin-bottom:10px;">Romance</h1>
        <p style="font-size:1.2rem; color:#333; max-width:600px; margin:0 auto 10px auto;">
           <strong>Seja bem-vindo à página de Romance Bibliotec!</strong><br>
            Encontre, crie e leia livros de romance compartilhados por nossa comunidade apaixonada por literatura.<br>
        </p>
    </section>
